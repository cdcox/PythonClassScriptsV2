# -*- coding: utf-8 -*-
"""
Created on Tue Nov 04 16:21:15 2014

@author: All members of UCI programming club 11/3/14 as taught by Kyle Ellefsen

Note, this is certainly not the cleanest way to do this, but was designed during
a competition. To clean it up move all imports to the top and turn the hard coded 
vars into variables. But it's a nice example and is totally functional.
"""
